...
func (this *Connection) SubscribeWithContext(ctx context.Context, channels []string, closure contracts.RedisSubscribeFunc) error {
...
func (this *Connection) PSubscribeWithContext(ctx context.Context, channels []string, closure contracts.RedisSubscribeFunc) error {
...
func (this *Connection) BitCountWithContext(ctx context.Context, key string, count *contracts.BitCount) (int64, error) {
...
func (this *Connection) HRandFieldWithContext(ctx context.Context, key string, count int, withValues bool) ([]string, error) {
...
func (this *Connection) GeoAddWithContext(ctx context.Context, key string, geoLocation ...*contracts.GeoLocation) (int64, error) {
	goredisLocations := make([]*goredis.GeoLocation, 0)
	for locationKey, value := range geoLocation {
		goredisLocations[locationKey] = &goredis.GeoLocation{
			Name:      value.Name,
...
func (this *Connection) GeoPosWithContext(ctx context.Context, key string, members ...string) ([]*contracts.GeoPos, error) {
	results := make([]*contracts.GeoPos, 0)
...
func (this *Connection) GeoRadiusWithContext(ctx context.Context, key string, longitude, latitude float64, query *contracts.GeoRadiusQuery) ([]contracts.GeoLocation, error) {
	results := make([]contracts.GeoLocation, 0)
...
func (this *Connection) GeoRadiusStoreWithContext(ctx context.Context, key string, longitude, latitude float64, query *contracts.GeoRadiusQuery) (int64, error) {
...
func (this *Connection) GeoRadiusByMemberWithContext(ctx context.Context, key, member string, query *contracts.GeoRadiusQuery) ([]contracts.GeoLocation, error) {
	results := make([]contracts.GeoLocation, 0)
...
func (this *Connection) GeoRadiusByMemberStoreWithContext(ctx context.Context, key, member string, query *contracts.GeoRadiusQuery) (int64, error) {
...
func (this *Connection) ZInterStoreWithContext(ctx context.Context, destination string, store *contracts.ZStore) (int64, error) {
...
func (this *Connection) ZPopMaxWithContext(ctx context.Context, key string, count ...int64) ([]contracts.Z, error) {
	results := make([]contracts.Z, 0)
...
func (this *Connection) ZPopMinWithContext(ctx context.Context, key string, count ...int64) ([]contracts.Z, error) {
	results := make([]contracts.Z, 0)
...
func (this *Connection) ZRangeByLexWithContext(ctx context.Context, key string, opt *contracts.ZRangeBy) ([]string, error) {
...
func (this *Connection) ZRevRangeByLexWithContext(ctx context.Context, key string, opt *contracts.ZRangeBy) ([]string, error) {
...
func (this *Connection) ZRangeByScoreWithContext(ctx context.Context, key string, opt *contracts.ZRangeBy) ([]string, error) {
...
func (this *Connection) ZRevRangeByScoreWithContext(ctx context.Context, key string, opt *contracts.ZRangeBy) ([]string, error) {
...
func (this *Connection) ZUnionStoreWithContext(ctx context.Context, key string, store *contracts.ZStore) (int64, error) {
